...
#ifndef IMAGE_DENOISING_BILATERAL_FILTER_H_
#define IMAGE_DENOISING_BILATERAL_FILTER_H_
...
#include "image_denoising/BilateralDynConfig.h"
...
{
public:
  using Config = BilateralDynConfig;

  BilateralFilter(const ros::NodeHandle & nh);
  ~BilateralFilter();
